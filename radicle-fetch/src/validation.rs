...
use radicle_git_ext::ref_format::{Qualified, RefString};
use thiserror::Error;

use crate::gix::refdb;
use crate::gix::{refdb::Ref, Refdb};
use crate::refs::{self, Refname, Special};
...
pub fn validate(
    ...
    for r in refs {
        ...
        match Refname::try_from(name.clone()) {
            ...
            Ok(refname) => {
                seen.insert(refname.to_qualified().into_refstring());
